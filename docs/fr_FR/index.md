...
Depuis mai 2021, jMQTT supporte la connexion aux Broker publique ou privé en MQTTS et la validation du Certificat du Serveur.
Le support d'un Certificat pour jMQTT sera implémenté dans un second temps.
