...
En cas de problème, merci d'ouvrir un thread sur [community ici](https://community.jeedom.com/tag/plugin-jmqtt) ou une issue sur [Github](https://github.com/BadWolf42/jMQTT/issues)
  ...
  - Correction de l'Ajout automatique des commandes qui pouvait générer des erreurs MySQL de type "Duplicate entry", voir Issue #89.
  - Le passage au nouveau démon déclenche correctement l'installation des nouvelles dépendances

## 2021-06-02
  - Correction PR #86 : mosquitto_pub ne prend plus en charge les '/' dans le clientId. Ils ont donc été remplacé par des '-'

## 2021-04-27
  - Correction PR #40: gestion du cas d'erreur de renommage du log d'un broker lorsque le log n'existe pas encore
...
## 2021-04-18
  ...
  - Correction Issue #35: Bug d'ajout de commande action puis info...
...
## 2021-03-26
  - Correction PR #22: Bug grisant toutes les commandes à la création d'un équipement jMQTT (revert d'une partie de la PR#17)

## 2021-03-25
  - Correction PR #17 & #19: Bug grisant toutes les commandes si l'on place un équipement jMQTT sur une Vue
  - Correction PR #11: Typo dans le code d'application de template

## 2021-03-23
  - Amélioration PR #7: Ajout de nouvelles icônes d'équipement (de mika41)
  - Correction PR #10: Désactivation de l'utilisation du js minifié
  - Correction PR #9: Correction problème d'affichage pour Jeedom 4.2 (de mika41)
  - Amélioration PR #8: Ajout de Secteur dans le placeholder de Type d'alimentation
  - Amélioration PR #6: Conversion des couleurs en HTML sur les commandes nommées "color","colour","couleur" ou "rgb"
  - Amélioration PR #5: Mise en place de petites icônes de visibilité et mode incluson sur les équipement + lazy image
  - Amélioration PR #4: Utilisation d'une liste ordonnée et indentée pour le choix de l'Objet parent
  - Amélioration PR #3 : Ajout du remplacement de #select#
  - Amélioration PR #2: Remplissage du topic de l'équipement sur double-click + ajout des champs min, max et listValue
...
## 2021-03-21
  ...
  - Correction PR #1: typo dans le code de vérification des dépendances
