    ...
    <div class="col-xs-12 eqLogicThumbnailDisplay">
        <div class="row">
            <div class="col-sm-10">
                ...
                $visibleDebug = config::byKey('debugMode', 'jMQTT', "0") === "1" ? 'danger' : 'danger hidden';
                displayActionCard('{{Debug}}', 'fa-toolbox', 'debugJMQTT', $visibleDebug);
                ?>
                </div>
            </div>
            <div class="col-sm-2">
        ...
        foreach ($eqBrokers as $eqB) {
            ...
            echo '<legend><i class="fas fa-table"></i> {{Equipements sur le broker}} <b>' . $eqB->getName() . '</b> (' . $nbEq . ')</legend>';
            echo '<div class="eqLogicThumbnailContainer">';
