...
<div class="col-xs-12"><span class="label control-label label-danger" style="width:100%;font-size: 13px!important">{{Ceci est la dernière version de jMQTT supportant Jeedom 3. Passez Jeedom en version 4.2 pour bénéficier des prochaines évolutions de jMQTT.}}</span></div>
