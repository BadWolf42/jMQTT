...
jmqtt_globals.logos = [
	...
	{id: 'air-quality', name: "{{Qualité de l'air}}", file: 'node_air-quality.svg'},
	{id: 'barometre', name: "{{Baromètre}}", file: 'node_barometre.svg'},
	{id: 'battery', name: "{{Batterie}}", file: 'node_battery.svg'},
	...
	{id: 'espeasy', name: "{{ESP Easy}}", file: 'node_espeasy.svg'},
	...
	{id: 'humidity', name: "{{Humidité}}", file: 'node_humidity.svg'},
	{id: 'humiditytemp', name: "{{Humidité et Température}}", file: 'node_humiditytemp.svg'},
	{id: 'hydro', name: "{{Hydrométrie}}", file: 'node_hydro.svg'},
	{id: 'intex', name: "{{Intex}}", file: 'node_intex.svg'},
	{id: 'ir2', name: "{{Infra Rouge}}", file: 'node_ir2.svg'},
	{id: 'jauge', name: "{{Jauge}}", file: 'node_jauge.svg'},
	{id: 'light', name: "{{Luminosité}}", file: 'node_light.svg'},
	{id: 'lightbulb', name: "{{Lumière}}", file: 'node_lightbulb.svg'},
	{id: 'location', name: "{{Localisation}}", file: 'node_location.svg'},
	{id: 'mcz-remote', name: "{{MCZ Remote}}", file: 'node_mcz-remote.svg'},
	{id: 'meteo', name: "{{Météo}}", file: 'node_meteo.svg'},
	{id: 'molecule-co', name: "{{CO (Monoxyde de carbone)}}", file: 'node_molecule-co.svg'},
	{id: 'molecule-co2', name: "{{CO2 (Dioxyde de carbone)}}", file: 'node_molecule-co2.svg'},
	{id: 'motion', name: "{{Mouvement}}", file: 'node_motion.svg'},
	{id: 'motion-sensor', name: "{{Présence}}", file: 'node_motion-sensor.svg'},
	{id: 'multisensor', name: "{{Multisensor}}", file: 'node_multisensor.svg'},
	{id: 'nab', name: "{{Nabaztag}}", file: 'node_nab.svg'},
	{id: 'openevse', name: "{{OpenEVSE}}", file: 'node_openevse.svg'},
	...
	{id: 'prise', name: "{{Prise}}", file: 'node_prise.svg'},
	{id: 'radiator', name: "{{Radiateur}}", file: 'node_radiator.svg'},
	{id: 'relay', name: "{{Relais}}", file: 'node_relay.svg'},
	...
	{id: 'rfid', name: "{{RFID}}", file: 'node_rfid.svg'},
	{id: 'solar-panel', name: "{{Panneau solaire}}", file: 'node_solar-panel.svg'},
	...
	{id: 'sms', name: "{{SMS}}", file: 'node_sms.svg'},
	{id: 'switch', name: "{{Interrupteur}}", file: 'node_switch.svg'},
	{id: 'sonometer', name: "{{Sonomètre}}", file: 'node_sonometer.svg'},
	{id: 'stove', name: "{{Poêle}}", file: 'node_stove.svg'},
	{id: 'tasmota', name: "{{Tasmota}}", file: 'node_tasmota.svg'},
	{id: 'teleinfo', name: "{{Téléinfo}}", file: 'node_teleinfo.svg'},
	{id: 'temp', name: "{{Température}}", file: 'node_temp.svg'},
	{id: 'theengs', name: "{{Theengs}}", file: 'node_theengs.svg'},
	{id: 'thermostat', name: "{{Thermostat}}", file: 'node_thermostat.svg'},
	{id: 'tv', name: "{{Télévison}}", file: 'node_tv.svg'},
	{id: 'ups', name: "{{Onduleur}}", file: 'node_ups.svg'},
