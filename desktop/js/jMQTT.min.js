...
$(".eqLogicAction[data-action=addBroker]").on("click",function(){bootbox.prompt("{{Nom du broker ?}}",function(a){null!==a&&jeedom.eqLogic.save({type:eqType,eqLogics:[{name:a,type:"broker"}],error:function(a){$("#div_alert").showAlert({message:a.message,level:"danger"})},success:function(a){var c=initPluginUrl();modifyWithoutSave=!1;c+="&id="+a.id+"&saveSuccessFull=1";loadPage(c)}})})});
