...
$(".typ-std").show(),$("#mqtttopic").prop("readonly",!1));var l=$("#broker");l.empty();$.each(eqBrokers,function(a,b){l.append(new Option(b,a))});l.val(a.configuration.brkId)}function saveEqLogic(a){var c=$("#div_broker_log").getValues(".configKey")[0];$.isEmptyObject(c)||(a.loglevel=c);c=Math.max.apply(Math,a.cmd.map(function(a){return a.order}));for(var d=a.cmd.length-1;0<=d;d--)""==a.cmd[d].id&&(""==a.cmd[d].name?a.cmd.splice(d,1):a.cmd[d].order=c+1);console.log(a.cmd);return a}
...
e+' placeholder="{{Topic}}" readonly=true />';b+="</td><td>";b+='<textarea class="form-control input-sm" data-key="value" style="height:65px;" '+e+' placeholder="{{Valeur}}" readonly=true />';b+='</td><td class="fitwidth">';b+='<input class="cmdAttr form-control input-sm" data-l1key="unite" placeholder="{{Unit\u00e9}}"></td><td>';is_numeric(a.id)?(b+='<span><label class="checkbox-inline"><input type="checkbox" class="cmdAttr checkbox-inline" data-l1key="isHistorized" checked/>{{Historiser}}</label></span> ',
b+='<span><label class="checkbox-inline"><input type="checkbox" class="cmdAttr checkbox-inline" data-l1key="isVisible" checked/>{{Afficher}}</label></span> ',b+='<span><label class="checkbox-inline"><input type="checkbox" class="cmdAttr checkbox-inline" data-l1key="display" data-l2key="invertBinary"/>{{Inverser}}</label></span> ',b+="</td><td>",b+='<a class="btn btn-default btn-xs cmdAction" data-action="configure"><i class="fa fa-cogs"></i></a> ',b+='<a class="btn btn-default btn-xs cmdAction" data-action="test"><i class="fa fa-rss"></i> {{Tester}}</a>'):
b+="</td><td>";void 0!=a.id&&void 0==a.configuration.irremovable&&(b+=' <a class="btn btn-default btn-xs cmdAction pull-right" data-action="remove"><i class="fa fa-minus-circle"></i></a>');b+="</td></tr>";$("#table_cmd tbody").append(b);$("#table_cmd tbody tr:last").setValues(a,".cmdAttr");isset(a.type)&&$("#table_cmd tbody tr:last .cmdAttr[data-l1key=type]").value(init(a.type));jeedom.cmd.changeType($("#table_cmd tbody tr:last"),init(a.subType));d(a.value);void 0!=a.id&&(c||jeedom.cmd.execute({id:a.id,
...
filter:{type:"info"},error:function(a){$("#div_alert").showAlert({message:a.message,level:"danger"})},success:function(c){b.find(".cmdAttr[data-l1key=value]").append(c);b.setValues(a,".cmdAttr");jeedom.cmd.changeType(b,init(a.subType))}}));c&&$(".tree").treegrid({initialState:"expanded"})}
