...
e=d.next();!e.done;e=d.next())e=e.value,e.sOrder=b(e);a.cmd.sort(function(a,b){return a.sOrder<b.sOrder?-1:a.sOrder>b.sOrder?1:0});$("#table_cmd").sortable("disable");$("#table_cmd th:first").width("120px")}else $("#table_cmd").sortable("enable"),$("#table_cmd th:first").width("50px")}
...
b+="</td></tr>";$("#table_cmd tbody").append(b);$("#table_cmd tbody tr:last").setValues(a,".cmdAttr");isset(a.type)&&$("#table_cmd tbody tr:last .cmdAttr[data-l1key=type]").value(init(a.type));jeedom.cmd.changeType($("#table_cmd tbody tr:last"),init(a.subType));jeedom.cmd.execute({id:a.id,cache:0,notify:!1,success:function(b){$(".cmd[data-cmd_id="+a.id+"] .form-control[data-key=value]").value(b);console.log($("#table_cmd tbody tr:last .cmdAttr[data-key=value]"));console.log(b)}});jeedom.cmd.update[a.id]=
function(b){$(".cmd[data-cmd_id="+a.id+"] .form-control[data-key=value]").value(b.display_value)};N_CMD++}"action"==init(a.type)&&(b='<tr class="cmd treegrid-'+N_CMD+'" data-cmd_id="'+init(a.id)+'">',b+="<td>",b+='<span class="cmdAttr" data-l1key="id"></span>',b+="</td>",b+="<td>",b+='<div class="row">',b+='<div class="col-sm-4">',b+='<a class="cmdAction btn btn-default btn-sm" data-l1key="chooseIcon" style="padding-left:5px;padding-right:5px;"><i class="fa fa-flag"></i>  Ic\u00f4ne</a>',b+='<span class="cmdAttr" data-l1key="display" data-l2key="icon" style="margin-left:5px;"></span>',
