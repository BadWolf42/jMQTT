...
function configureIncludeModeDisplay(a,c){1==c?($(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"]:not(.card)").removeClass("btn-default").addClass("btn-success"),$(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"]").attr("data-mode",1),$(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"].card span").text("{{Arr\u00eater l'inclusion}}"),$(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"]").addClass("include"),$("#div_inclusionModeMsg").showAlert({message:"{{Mode inclusion automatique pendant 2 \u00e0 3min. Cliquez sur le bouton pour forcer la sortie de ce mode avant.}}",
level:"warning"})):($(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"]:not(.card)").addClass("btn-default").removeClass("btn-success btn-danger"),$(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"]").attr("data-mode",0),$(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"].card span").text("{{Mode inclusion}}"),$(".eqLogicAction[data-action=changeIncludeMode][brkId="+a+"]").removeClass("include"),$("#div_inclusionModeMsg").hideAlert())}
